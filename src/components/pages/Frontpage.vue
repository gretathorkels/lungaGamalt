<template>
  <div class="frontpage">
    ...
    <div class="navigation">
      <div
        class="skew-container link-container"
        v-bind:class="{ rightalign: this.$i18n.locale=='en'}"
      >
        <div>
          <router-link
            class="nav-link"
      ...
      >
        <div>
          <router-link
            ...
            v-bind:class="{icelandic: this.$i18n.locale=='isl', english: this.$i18n.locale=='en'}"
            to="/eventindex"
          >{{ $t('links.eventindex') }}</router-link>
        </div>
      </div>
      <div
        class="skew-container link-container"
    ...
    <div class="little-nav ">
      <!-- <div class="grid-container"> -->
        ...
        <div class="skew-container link-container divider" v-bind:class="{ rightalign: this.$i18n.locale=='en'}">
          <div>
            <router-link
              class="nav-link"
              v-bind:class="{icelandic: this.$i18n.locale=='isl', english: this.$i18n.locale=='en'}"
